...
function myTest() {
    assert.strictEqual(toReadable(0), 'zero');
    assert.strictEqual(toReadable(1), 'one');
    assert.strictEqual(toReadable(2), 'two');
    assert.strictEqual(toReadable(3), 'three');
    assert.strictEqual(toReadable(4), 'four');
    assert.strictEqual(toReadable(5), 'five');
    assert.strictEqual(toReadable(6), 'six');
    assert.strictEqual(toReadable(7), 'seven');
    assert.strictEqual(toReadable(8), 'eight');
}

try {
    myTest();
    console.log("Well done Mashechka!!!!!")
} catch (error) {
